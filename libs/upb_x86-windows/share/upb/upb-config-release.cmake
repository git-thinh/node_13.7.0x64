...
# Import target "upb::legacy_msg_reflection" for configuration "Release"
set_property(TARGET upb::legacy_msg_reflection APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(upb::legacy_msg_reflection PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/legacy_msg_reflection.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS upb::legacy_msg_reflection )
list(APPEND _IMPORT_CHECK_FILES_FOR_upb::legacy_msg_reflection "${_IMPORT_PREFIX}/lib/legacy_msg_reflection.lib" )
